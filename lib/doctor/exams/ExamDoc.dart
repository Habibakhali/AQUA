...
class ExamItemDoc extends StatelessWidget {
  String exam, date;
  String routeName;
  FilePickerResult?path;
  ExamItemDoc(this.exam, this.date, this.routeName,this.path,);
            ...
            Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height:10 ,),
                    Text(path!.names.first!,style: TextStyle(color: Color(0xFF6C7174),fontSize: 15),),
                  ],
                )),
