                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: TextField(
                      onChanged: (value){
                        setState(() {
                          courseName=courseName.where((element) => element.contains(value.toLowerCase()))
                              .toList();
                        });
                      },
                      ...
                      decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            ...
                            icon: Icon(Icons.cancel,color: _textEditingController!.text.isNotEmpty?Colors.red:Colors.grey,),
                          )),
                    ),
                  ),
                ),
                ...
                Expanded(
                  child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Partment(courseName[index], coursesRoutes[index],
