...
class _HomeScreenDoctorState extends State<HomeScreenDoctor> {
  ...
  Widget build(BuildContext context) {
    List<Widget>tabs=[ExamDoc(),OfficeHours(),Table(),PersonalSetting()];
      ...
      bottomNavigationBar: Theme(
        ...
        child: BottomNavigationBar(
          ...
          items: [
            ...
            BottomNavigationBarItem(icon: ImageIcon(AssetImage('assets/images/data-sheet.png'),),label: AppLocalizations.of(context)!.table),
