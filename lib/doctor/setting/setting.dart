...
class SettingsPageDoc extends StatefulWidget {
  static const String routeName = 'SettingprofGRd';

  @override
  State<SettingsPageDoc> createState() => _SettingsPageDocState();
}

class _SettingsPageDocState extends State<SettingsPageDoc> {
  @override
