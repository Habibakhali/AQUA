                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            OutlinedButton(style:OutlinedButton.styleFrom(backgroundColor:Colors.red ),onPressed: (){
                                              ApiManager.delCourseReservation(idCourse[index]);
                                              Navigator.pop(context);
                                            }, child: Row(
                                              children: [
                                ...
                                showDialog(context: context, builder: (context)=>SimpleDialog(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                        ...
                                        onTap: (){
                                          Navigator.pushReplacementNamed(context, QUestionHome.routeName,);
                                        }),
                                  ],
                                ));
                            },child: Image.asset('assets/images/ocourse.png',width: 150,height: 150,))),
                            Expanded(child: Center(
                              child: Text(coursesSelectedCourses![index], textAlign: TextAlign.center,
